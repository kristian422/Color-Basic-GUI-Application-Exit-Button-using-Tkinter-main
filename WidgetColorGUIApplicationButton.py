...
window.title("ADOLF RIZZLER") #Title of the Message Window // Will appear on the Top // title widget
...
button = Button(window, text='WANNA GET RIZED?', command=window.destroy, fg='blue', bg='white', height=10, width=40, padx=5, pady=5).pack() #create a button 
